...
function myGameSetUp()
    ...
    local drinkImage = gfx.image.new("Images/drinkImage.png")
    ...
    drinkInstance.sprite:moveTo( 200, 120 ) -- this is where the center of the sprite is placed; (200,120) is the center of the Playdate screen
    ...
    local backgroundImage = gfx.image.new( "Images/backgroundImage.png" )
